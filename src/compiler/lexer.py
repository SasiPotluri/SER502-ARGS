...
import required.position as position
import string
...
class Lexer:
	...
	def make_tokens(self):
		...
		while self.current_char != None:
			if self.current_char in ' \t':
				...
				self.advance()
				return [], errorclass.IllegalCharError(pos_start, self.pos, "'" + char + "'")
	...
	def make_bool(self):
		...
		while self.current_char and self.current_char.isalpha():
			bool_str += self.current_char.lower()
			self.advance()
		...
		if bool_str == "true":
			...
			return Token(TT_BOOL, bool_str, pos_start, self.pos)
